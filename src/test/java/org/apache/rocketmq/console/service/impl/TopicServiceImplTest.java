...
public class TopicServiceImplTest extends RocketMQConsoleTestBase {
    ...
    public void fetchAllTopicList() throws Exception {
        ...
        Assert.assertTrue(!CollectionUtils.isEmpty(topicList.getTopicList()));
    ...
    public void route() throws Exception {
        ...
        Assert.assertTrue(!CollectionUtils.isEmpty(topicRouteData.getQueueDatas()));
    }
...
//            if (!CollectionUtils.isEmpty(groupList.getGroupList())) {
//                break;
//            }
//            Thread.sleep(1000);
//        }
    ...
    public void examineTopicConfig() throws Exception {
        ...
        Assert.assertTrue(!CollectionUtils.isEmpty(topicConfigInfoList));
    }
