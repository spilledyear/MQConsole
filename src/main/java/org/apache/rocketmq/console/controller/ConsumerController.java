...
public class ConsumerController {
    ...
    public Object consumerCreateOrUpdateRequest(@RequestBody ConsumerConfigInfo consumerConfigInfo) {
        Preconditions.checkArgument(!CollectionUtils.isEmpty(consumerConfigInfo.getBrokerNameList()) || !CollectionUtils.isEmpty(consumerConfigInfo.getClusterNameList()),
