...
public class TopicController {
    ...
    public Object topicCreateOrUpdateRequest(@RequestBody TopicConfigInfo topicCreateOrUpdateRequest) {
        Preconditions.checkArgument(!CollectionUtils.isEmpty(topicCreateOrUpdateRequest.getBrokerNameList()) || !CollectionUtils.isEmpty(topicCreateOrUpdateRequest.getClusterNameList()),
